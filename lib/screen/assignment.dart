        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  margin: const EdgeInsets.only(bottom: 15, left: 70),
          ...
          Container(
            child: Stack(
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 70, right: 20, top: 20),
                  decoration: BoxDecoration(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(15),
                      child:
                          Image.asset('assets/guitar.png', color: Colors.white),
                    ),
                  ),
                ),
                Positioned(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(15),
                      child:
                          Image.asset('assets/math.png', color: Colors.white),
                    ),
                  ),
                ),
                Positioned(
